...
import {
  ...
  updateManySchema,
  updateTodoSchema
} from '../databases/schemas/todo.schema';
...
todoRoute.put('/todos/update-many', validateInput(updateManySchema), todoController.updateManyTodo);
todoRoute.put('/todos/:todoId', validateInput(updateTodoSchema), todoController.updateCompletedTodo);

todoRoute.delete('/todos/delete-many', validateInput(deleteManySchema), todoController.deleteManyTodo);
