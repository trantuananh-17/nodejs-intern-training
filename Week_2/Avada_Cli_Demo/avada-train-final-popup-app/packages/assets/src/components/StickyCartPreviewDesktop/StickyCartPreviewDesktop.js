...
export default function StickyCartPreviewDesktop({options, onSubmit}) {
  ...
  return (
    <>
      <div className="Avada-StickyATC-ProductInfo__Left">
      ...
      <div className="Avada-StickyATC-ProductInfo__Right">
